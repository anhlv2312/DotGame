   ...
   Code
       Functionality
           ...
           Task 2
               CompanionDot
               Dot
                   Dot is implemented perfectly (handles appropriate edge cases)
               Companion
                   Companion is implemented perfectly (activation considers appropriate edge cases)
           Task 3
               Loading and saving should show dialog boxes to allow the user to choose a save file
           Postgraduate Task
               ActionBar
                   Solid implementation
                   Implemented sensibly using good class design
               Dots & Companions
                   Solid implementation
       Code Style
           Performance (%)
